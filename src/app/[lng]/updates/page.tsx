                        ...
                        <div className='space-y-2'>
                            <div className="w-full md:w-[80vw] lg:w-[70vw] border border-primary rounded-xl">
                                <button
                                    ...
                                    onClick={() => toggleEditPanelSection(16)}
                                >   
                                    <div>
                                        0.1.05 <span className='text-grey ml-1 text-sm'>—&nbsp; xx/xx/2026</span>
                                    </div>
                                    {editPanelIndex === 16 ? (
                                ...
                                <div
                                    ...
                                    editPanelIndex === 16 ? 'm-2 mt-0' : 'max-h-0 p-0 border-0'
                                    }`}
                                >   
                                    <p className="text-sm">
                                        - All languages added to create exam paper page<br/>
                                        - Google Analytics updated<br/>
                                    </p>
                            ...
                            <div className="w-full md:w-[80vw] lg:w-[70vw] border border-primary rounded-xl">
                                <button
                                    className="w-full text-2xl flex justify-between items-center px-4 py-2 bg-transparent text-primary text-base transition cursor-pointer"
                                    onClick={() => toggleEditPanelSection(15)}
                                >   
                                    <div>
                                        0.1.04 <span className='text-grey ml-1 text-sm'>—&nbsp; 02/05/2026</span>
                                    </div>
                                    {editPanelIndex === 15 ? (
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 9L12 15L18 9" stroke="currentColor" strokeWidth="2" />
                                ...
                                <div
                                    className={`flex flex-col px-2 overflow-hidden transition-all duration-400 ease-linear space-y-2 ${
                                    editPanelIndex === 15 ? 'm-2 mt-0' : 'max-h-0 p-0 border-0'
                                    }`}
                                >   
                                    <p className="text-sm">
                            ...
                            <div className="w-full md:w-[80vw] lg:w-[70vw] border border-primary rounded-xl">
                                ...
                                >   
                                    <div>
                                        0.1.03 <span className='text-grey ml-1 text-sm'>—&nbsp; 27/04/2026</span>
                                    </div>
                                    {editPanelIndex === 14 ? (
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 9L12 15L18 9" stroke="currentColor" strokeWidth="2" />
                            ...
                            <div className="w-full md:w-[80vw] lg:w-[70vw] border border-primary rounded-xl">
                                ...
                                <div
                                    className={`flex flex-col px-2 overflow-hidden transition-all duration-400 ease-linear space-y-2 ${
                                    editPanelIndex === 13 ? 'm-2 mt-0' : 'max-h-0 p-0 border-0'
                                    }`}
                                >   
                                    <p className="text-sm">
                            ...
                            <div className="w-full md:w-[80vw] lg:w-[70vw] border border-primary rounded-xl">
                                <button
                                    className="w-full text-2xl flex justify-between items-center px-4 py-2 bg-transparent text-primary text-base transition cursor-pointer"
                                    onClick={() => toggleEditPanelSection(12)}
                                >   
                                    <div>
                                        0.1.01 <span className='text-grey ml-1 text-sm'>—&nbsp; 23/04/2026</span>
                                    </div>
                                    {editPanelIndex === 12 ? (
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 9L12 15L18 9" stroke="currentColor" strokeWidth="2" />
                                ...
                                <div
                                    className={`flex flex-col px-2 overflow-hidden transition-all duration-400 ease-linear space-y-2 ${
                                    editPanelIndex === 12 ? 'm-2 mt-0' : 'max-h-0 p-0 border-0'
                                    }`}
                                >   
                                    <p className="text-sm">
                                        - Landing page updated<br/>
                                        - Exam papers preview and download added<br/>
                                        - Exam papers AQA and Edexcel 2024 added<br/>
                            ...
                            <div className="w-full md:w-[80vw] lg:w-[70vw] border border-primary rounded-xl">
                                ...
                                <div
                                    className={`flex flex-col px-2 overflow-hidden transition-all duration-400 ease-linear space-y-2 ${
                                    editPanelIndex === 9 ? 'm-2 mt-0' : 'max-h-0 p-0 border-0'
                                    }`}
                                >   
                                    <p className="text-sm">
                                        - Meta data update <br/>
                                        ...
                                        - Export file updates <br/>
                                        - Export loading fonts optimisation <br/>
                                    </p>
