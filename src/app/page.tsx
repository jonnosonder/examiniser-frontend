      ...
      ></div>
        ...
        <div className="flex flex-col z-[2] w-[50vw] items-center justify-center">
          <div className='p-8'>
            ...
            <p id="heroP" className="mt-2 max-w-sm sm:max-w-md lg:max-w-xl text-primary sm:text-lg lg:text-xl break-words">An editor specialised in making question and exam papers. Easy to create and navigate with inbuilt templaets all for free!</p>
