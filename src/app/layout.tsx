...
export const metadata: Metadata = {
  ...
  openGraph: {
    siteName: 'Examiniser',
    title: 'Examiniser - Infinite Math Questions Generator',
    description: 'Generate an infinite number of math questions for free with Examiniser. Perfect for students, teachers, and anyone looking to practice math skills around the world.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Examiniser - Infinite Math Questions Generator',
      },
    ],
    type: 'website',
