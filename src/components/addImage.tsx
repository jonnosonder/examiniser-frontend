        ...
        <div className='absolute flex z-20 w-screen h-screen bg-opacity-50 backdrop-blur-sm items-center justify-center left-0 top-0 right-0'>
            <div className="flex flex-col bg-background border border-grey space-y-4 p-2 shadow-md rounded-lg max-h-[80%]">
                <div className="flex w-full items-center justify-between">
                    <h2 className="p-2 font-nunito text-xl">{t('add-image.add-image')}</h2>
                ...
                <div className="flex w-full justify-between">
                    ...
                    <button onClick={addButtonHandler} className="border-2 border-primary text-primary text-lg rounded-lg py-1 px-4 transition-shadow duration-300 hover:shadow-[0_0_0_0.4rem_theme('colors.accent')] hover:outline-none">{t('add-image.add')}</button>
                </div>
            </div>
